...
public class Positioning {
	...
	private static final double WHEEL_BASE_LENGTH = 20.875, WHEEL_BASE_WIDTH = 26.125;
	...
	private static final double ENCODER_SCALE = 1.0 / ((80.0 * 6.67) / (4.0 * Math.PI)), STEERING_SCALE = TWO_PI / 1024.0;
	...
	public double getFieldZeroHeading() {
		return fieldZeroHeading;
	}
	
	public void setFieldZeroHeading(double heading) {
		fieldZeroHeading = heading;
	}
